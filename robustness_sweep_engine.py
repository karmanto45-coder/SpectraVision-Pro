...
def _trapz(y, x):
    ...
    # abs(): np.trapezoid bernilai NEGATIF untuk wavenumber menurun; luas
    # fisik selalu positif (lihat mcr_engine.abs_area).
    ...
    for i, label in enumerate(component_labels):
        ...
        if amb_comp is not None:
            ...
            siri_result = compute_identity_robustness_index(
                amb_comp["S_nominal"], amb_comp["S_band_min"], amb_comp["S_band_max"], S_reference[i],
            )
